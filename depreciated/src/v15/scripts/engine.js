...
function init() {
	...
	paragraph.innerHTML = "Tryit Editor v1.5.6 &copy; 2010-2011 by Kevin Zucchini. If you would like to use my API for customizing the textarea text, click <a href='api.html' title='API'>here</a>";
