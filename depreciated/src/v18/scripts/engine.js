...
function init() {
	document.getElementById("code1").value = "<html>\n  <head>\n    <title>Hello World</title>\n    <script type=\"text/javascript\" src=\"scripts/jquery.js\"></scr" + "ipt>\n    <style>\n      h1 {\n        text-align: center;\n      }\n    </style>\n  </head>\n  <body>\n    <h1>Hello World!</h1>\n    <p>This is a test page</p>\n  </b" + "ody>\n</" + "html>";
	if (location.search != null || location.search != "") {
		...
		if (xxx.indexOf("?") != -1) {
			...
			document.getElementById("code1").value = xxx.substring(5, xxx.length);
		}
	}
	statusline("ready");
	...
	codeMirror = CodeMirror.fromTextArea(document.getElementById("code1"), {lineNumbers: true, matchBrackets: true, lineWrapping: true, mode: "text/html", tabMode: "indent", onCursorActivity: function() {codeMirror.setLineClass(hlLine, null);hlLine = codeMirror.setLineClass(codeMirror.getCursor().line, "activeline");}});
	var hlLine = codeMirror.setLineClass(0, "activeline");
	codeMirror.setOption("theme", "eclipse");
	startit();
	var paragraph = document.createElement("p");
	paragraph.innerHTML = "Tryit Editor v1.5.6 &copy; 2010-2011 by Kevin Zucchini.";
