...
function init() {
	...
	codeMirror = CodeMirror.fromTextArea(document.getElementById("code1"), {lineNumbers: true, mode: "text/html", tabMode: "indent", onCursorActivity: function() {codeMirror.setLineClass(hlLine, null);hlLine = codeMirror.setLineClass(codeMirror.getCursor().line, "activeline");}});
